...
<body>
    <div id="display">
       <p id="header_tittle">Μπράβο!</p>
       <img id="icon_endscreen" src="img/green-tick-png.png" alt="Green Tick">
       <a  style="left:100px;" class="games2_endscreen_btn hover-btn" href="games2.php">ΈΠΟΜΕΝΟ</a>
